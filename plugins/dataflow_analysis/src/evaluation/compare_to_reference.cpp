...
namespace hal
{
    namespace evaluation
    {
        ...
        SimilarityScore compare_to_reference(const std::shared_ptr<hal::dataflow::Grouping>& reference_state, const std::shared_ptr<hal::dataflow::Grouping>& candidate_state)
        {
        ...
        {
            std::unordered_map<std::shared_ptr<hal::dataflow::Grouping>, SimilarityScore> output;
